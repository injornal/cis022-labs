...
def main():
    ...
    try:
        array_currency = []
        krone_objects_value = [57.12, 23.44, 87.43, 68.99, 111.22, 44.55, 77.77, 18.36, 543.21, 20.21, 345.67, 36.18, 48.48, 101.00, 11.00, 21.00, 51.00, 1.00, 251.00, 151.00]

        for value in krone_objects_value:
            array_currency.append(Krone(value))
        countCurrency = len(array_currency)
        ...
        print(f"Kr 44.56 is in index {singly_linked_list.find_currency(Krone(44.55))} in singly_linked_list") # Check this again 44.55 or 44.56?
        ...
        # What is countCurrency?
        singly_linked_list.remove_currency(countCurrency % 6)
        # singly_linked_list.remove_currency(countCurrency / 7)
